...
# takes in a string of numbers that represent a pin. 3452=> 3 4 5 2 not 3,452.
# The incoming numbers need to used to create all permutations of the string that fit the number pad.
